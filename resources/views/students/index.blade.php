    ...
    <div class="modal-container">
        ...
        <form action="{{ route('students.store') }}" method="POST" autocomplete="off" id="modal-create-form">
            ...
            <div class="modal-body">
                ...
                <div class="form-group"><label>Course</label><div class="input-wrapper sw"><svg class="fi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg><select name="course" required><option value="" disabled selected>Select a course…</option><option>Computer Science</option><option>Information Technology</option><option>Software Engineering</option><option>Data Science</option><option>Cyber Security</option><option>Business Administration</option></select></div></div>
                ...
                <div class="form-group"><label>Password</label><div class="input-wrapper"><svg class="fi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg><input type="password" name="password" placeholder="Leave blank to use default (student123)" minlength="6"></div></div>
            </div>
    ...
    <div class="modal-container">
        ...
        <form method="POST" autocomplete="off" id="modal-edit-form">
            ...
            <div class="modal-body">
                ...
                <div class="form-group"><label>Course</label><div class="input-wrapper sw"><svg class="fi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg><select name="course" id="edit_course" required><option value="" disabled>Select a course…</option><option>Computer Science</option><option>Information Technology</option><option>Software Engineering</option><option>Data Science</option><option>Cyber Security</option><option>Business Administration</option></select></div></div>
...
function openImportModal(){
    Swal.fire({
        ...
        html:'<div style="text-align:left;font-size:.85rem;color:#525252;margin-bottom:1rem">' +
             ...
             '<p style="font-size:.78rem;color:#a3a3a3">• First row should be headers<br>• Duplicate emails will be skipped<br>• Grade should be "Grade 9" or "Grade 10"<br>• Max file size: 10MB</p></div>' +
