    ...
    <div class="wrapper">
        <div class="container">
            <div class="header">
                ...
                <div class="header-subtitle">Teacher Workspace Access</div>
            </div>
            <div class="content">
                <h1 class="salutation">Welcome, {{ $teacher->salutation ? $teacher->salutation . ' ' : '' }}{{ $teacher->last_name }}!</h1>
                <p class="body-text">
                    You have been registered as a Teacher on the CodeXpress portal. Below are your temporary account login credentials to access your teacher dashboard.
                </p>
                ...
                <div class="credentials-card">
                    ...
                    <div class="credential-row">
                        ...
                        <span style="color: #4f46e5; font-weight: 600;">{{ url('/teacher/login') }}</span>
                    </div>
                    <div class="credential-row">
                    ...
                    <div class="credential-row" style="margin-top: 12px; padding-top: 12px; border-top: 1px dashed #e4e4e7;">
                        ...
                        <span style="color: #09090b; font-weight: 600;">{{ $teacher->subject }}</span>
                    </div>
                    @endif
                </div>
                ...
                <p class="body-text" style="font-size: 14px; background-color: #eff6ff; border: 1px solid #bfdbfe; color: #1e40af; padding: 12px 16px; border-radius: 8px; margin-bottom: 28px;">
                    <strong>Notice:</strong> For security reasons, we strongly recommend changing your password immediately after your first login via the "My Profile" page.
                </p>

                <div class="btn-wrapper">
                    <a href="{{ url('/teacher/login') }}" class="btn" target="_blank">Access Teacher Portal</a>
                </div>
